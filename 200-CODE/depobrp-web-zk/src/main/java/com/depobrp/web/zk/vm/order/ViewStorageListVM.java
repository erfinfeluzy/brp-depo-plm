...
@Component("ViewStorageListVM")
@Scope("prototype")
public class ViewStorageListVM {
	...
	public void lookupContainer(){
		containerList = service.getOnStorageList(filter, fromDate, toDate, activePage, maxRowPerPage);
	}
	
	@Command
	public void prepareMoveOUT(@BindingParam("selectedContainer") FreightContainer container){
		...
		if(container != null && container.getId() != null){
			...
			Window popupWin = (Window) Executions.createComponents(
					"/widgets/modal/move-out.zul", null, param);
