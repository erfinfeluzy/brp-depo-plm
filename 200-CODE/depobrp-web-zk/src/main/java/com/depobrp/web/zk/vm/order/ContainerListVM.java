...
@Component("ContainerListVM")
@Scope("prototype")
public class ContainerListVM {
	...
	public void lookupContainer(){
		...
		containerList = service.getFreightContainerList(filter, fromDate, toDate, activePage, maxRowPerPage, null);
	}
